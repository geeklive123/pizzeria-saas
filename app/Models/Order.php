...
#[Fillable(['company_id', 'branch_id', 'restaurant_table_id', 'active_restaurant_table_id', 'order_number', 'type', 'status', 'customer_name', 'customer_phone', 'notes', 'subtotal', 'discount_total', 'total', 'opened_at', 'closed_at', 'created_by'])]
