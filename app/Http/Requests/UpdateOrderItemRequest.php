...
class UpdateOrderItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'fulfillment_type' => ['required', Rule::enum(OrderType::class)],
            'notes' => ['nullable', 'string', 'max:500'],
            'sections' => ['nullable', 'array', 'min:1', 'max:4'],
            'sections.*.variant' => ['required', 'string', 'distinct', Rule::exists('product_variants', 'ulid')->where('company_id', $companyId)],
